...
export default function AgentSquare({ agentImage, agentName }: AgentPolaroid) {
  return (
    <Card sx={{ width: "100%", height: "60%", border: "1px solid grey" }}>
      <CardMedia
        component="img"
        ...
        alt={agentName}
      />
      <CardContent style={{ backgroundColor: "#fff", paddingTop: 0 }}>
        <Box sx={{ width: "1rem", height: 30, display: "flex", fontSize: "8px", justifyContent: "center" }}>
          {agentName}
        </Box>
      </CardContent>
    </Card>
